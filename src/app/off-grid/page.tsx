...
export default function OffGridPage() {
    const filteredPosts = posts.filter(post => post.category === "Off Grid");
        ...
        <div className="section">
            <div className="block-content top-bot-margin">
                <div className="section-title-line">
                    ...
                    <h1 className="section-title">Off Grid Living</h1>
                ...
                <p className="paragraph" style={{ maxWidth: '600px', marginBottom: '40px' }}>
                    Discover the beauty of self-sufficiency. From solar power to sustainable gardening,
                    explore our collection of stories and tips for living off the grid.
                </p>
